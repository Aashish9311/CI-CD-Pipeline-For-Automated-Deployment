...
def add_products(apps, schema_editor):
    ...
    Product.objects.create(name="intern", description="A sturdy mountain bicycle.", price=3500)
    ...
    Product.objects.create(name="Intern",description="to learn deveops",price=free)
class Migration(migrations.Migration):
